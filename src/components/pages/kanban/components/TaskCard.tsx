...
const TaskCard: React.FC<TaskCardProps> = ({
  ...
  return (
    <div
      className={`w-full max-w-none bg-white rounded-xl shadow-md p-4 mb-2 border border-gray-100 hover:border-gray-200 transition-all duration-300 ease-in-out  
